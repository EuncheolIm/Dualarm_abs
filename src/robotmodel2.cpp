...
void CModel::load_model()
{
	...
	// RigidBodyDynamics::Addons::URDFReadFromFile("../model/dualarm_hands_mod_sim1.urdf", &_model, false, true);	
	RigidBodyDynamics::Addons::URDFReadFromFile("/home/kist/cowork/model/urdf1/dual_arm/dualarm1.urdf", &_model, false, true);	
	// RigidBodyDynamics::Addons::URDFReadFromFile("/home/kist/euncheol/cowork/model/urdf/dual_arm/dualarm_test.urdf", &_model, false, true);		
